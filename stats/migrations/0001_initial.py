...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"db_table": "audit_log", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="AuditLogCrawl",
            fields=[
            ...
            options={"db_table": "audit_log_crawl", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "channel_categories", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Channels",
            fields=[
            ...
            options={"db_table": "channels", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Emojis",
            fields=[
            ...
            options={"db_table": "emojis", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Mentions",
            fields=[
            ...
            options={"db_table": "mentions", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Messages",
            fields=[
            ...
            options={"db_table": "messages", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Pins",
            fields=[
            ...
            options={"db_table": "pins", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Reactions",
            fields=[
            ...
            options={"db_table": "reactions", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Roles",
            fields=[
            ...
            options={"db_table": "roles", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Typing",
            fields=[
            ...
            options={"db_table": "typing", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="Users",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "owner_id",
                    models.ForeignKey(
                        "Users", on_delete=models.DO_NOTHING, db_column="owner_id"
                    ),
                ),
                ("name", models.TextField()),
            ...
            options={"db_table": "guilds", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="RoleMembership",
            fields=[
            ...
            options={"db_table": "role_membership", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            name="VoiceChannels",
            fields=[
            ...
            options={"db_table": "voice_channels", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "audit_log_changes", "managed": settings.IS_TESTING},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "guild_membership", "managed": settings.IS_TESTING},
        ),
    ]
